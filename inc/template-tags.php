...
if ( ! function_exists( 'principal_investigator_author_bio' ) ) :
    function principal_investigator_author_bio() {
        ...
        <div class="entry-author">
            ...
            <div class="author-heading">
                <h2 class="author-title"><?php printf( esc_html__( 'Principal Investigator %s', 'jetpack' ),
                        '<span class="author-name">' . get_the_author() . '</span>' ); ?></h2>
            </div><!-- .author-heading -->
